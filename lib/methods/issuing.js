...
function getBadgeInstancesByBadge(options, callback) {
  if (!callback) {
    callback = options;
    options = {};
  }
 ...
 */
function getBadgeInstancesByEvidence(options, callback) {
...
module.exports = {
  ...
  getBadgeInstancesByBadge: getBadgeInstancesByBadge,
  getBadgeInstancesByRecipient: getBadgeInstancesByRecipient,
  getBadgeInstancesByEvidence: getBadgeInstancesByEvidence
};
